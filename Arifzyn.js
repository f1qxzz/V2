/*
   Created By f1qxzz
   My Contact wa.me/62895422604542
*/
...
module.exports = conn = async (conn, m, msg, chatUpdate, store) => {
  try {
    ...
    const isAdrian = "62895422604542@s.whatsapp.net".includes(m.sender);
    /* ~~~~~~~~~ GROUP SYSTEM ~~~~~~~~~ */
...
`.trim();
      ...
      case "script":
      case "scriptbot":
        uy = `https://instagram.com/f1qxzz_`;
        conn.sendMessage(
          m.chat,
          {
            text: uy,
            contextInfo: {
              externalAdReply: {
                showAdAttribution: true,
                title: "Script Free",
                body: `SCRIPT BOT ${namabot} Ada Di Instagram @f1qxzz_`,
                thumbnailUrl:
      ...
      case "tqto":
        m.reply(
          `*Terima Kasih Kepada*\n>| 1 LoL Human ( Rest APIs )\n>| 2. ZTRAM ( Team )\n>| 3. Penyedia Module WhatsApp\n\n\n\n\n\n Powered By f1qxzz`,
        );
        break;
      ...
      case "ytmp4":
        {
          ...
          await conn.sendMessage(
            m.chat,
            {
              ...
              mimetype: "video/mp4",
              fileName: "Downloader Ytmp4 By f1qxzz.mp4",
              caption: ytmp4p,
              contextInfo: {
                externalAdReply: {
                  showAdAttribution: true,
      ...
      case "ytmp3":
        {
          ...
          await conn.sendMessage(
            m.chat,
            {
              ...
              mimetype: "audio/mp3",
              fileName: "Downloader Ytmp3 By f1qxzz.mp3",
              caption: ytmp4p,
              contextInfo: {
                externalAdReply: {
                  showAdAttribution: true,
